...
def main():
    ...
    parser.add_argument('-dtype', '--DATATYPE', help='set datasets, if you want to use custom dataset, use "custom"', type=str, default='iwslt')
    parser.add_argument('-root', '--ROOTPATH', help='root path', type=str, default='../data/')
    parser.add_argument('-maxlen', '--MAX_LEN', help='Max length of sentence', type=int, default=30)
    ...
    parser.add_argument('-pee', '--PRINT_EVERY', help='Eval Every', type=int, default=10)
    # model
    ...
    parser.add_argument('-load', '--LOAD', help='load model', action='store_true')
